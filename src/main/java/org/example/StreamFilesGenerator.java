...
public class StreamFilesGenerator {
    ...
    public static void main(String[] args) {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("Files/Streams/stress2.csv"))) {
            // Write header
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("Files/Streams/weight2.csv"))) {
            // Write CSV header
        ...
        try (FileWriter writer = new FileWriter("Files/Streams/stress2.json")) {
        ...
        try (FileWriter writer = new FileWriter("Files/Streams/weight2.json")) {
            Gson gson = new GsonBuilder().setPrettyPrinting().create();
